        ...
        child: Center(
          child: Column(
            children: [
              ...
              Text("Login",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w600,fontSize: 20),),

              SizedBox(
                height: size.height*0.04,
              ),

              const Text("Dont have an Account?",style: TextStyle(color: Colors.white,fontSize: 17),),

              InkWell(onTap: (){
                Get.off(()=> SignUpScreen(),transition: Transition.rightToLeft);
              },child: const Text("SignUp",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w600,fontSize: 18.5,decoration: TextDecoration.underline,decorationColor: Colors.white),)),
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  child: Text("Login",style: TextStyle(color: myGreen,fontWeight: FontWeight.bold,fontSize: 18),),
                ),
              ),
